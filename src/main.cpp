...
#define CURRENT_FIRMWARE_TITLE "Lab3_OTA"
...
constexpr char WIFI_SSID[] = "OPPO A73 5G";
constexpr char WIFI_PASSWORD[] = "elyelyely";
constexpr char TOKEN[] = "Your_Core_IoT_Device_Token";
